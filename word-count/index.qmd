...
<h1 class="govuk-heading-l">Word Count</h1>

<form method="POST" novalidate>
 <div class="govuk-form-group {% if error %}govuk-form-group--error{% endif %}">
  <label class="govuk-label" for="url">Enter a URL</label>
  <span id="url-hint" class="govuk-hint">Example: https://www.gov.uk</span>
  ...
  <input class="govuk-input {% if error %}govuk-input--error{% endif %}" id="url" name="url" type="text" spellcheck="false" aria-describedby="url-hint {% if error %}url-error{% endif %}" required>
 </div>

 <button type="submit" class="govuk-button" data-module="govuk-button">Count words</button>
</form>
