...
<form action="/pay" method="post" class="govuk-!-margin-bottom-6 govuk-form-group">
  ...
  <span id="userText-hint" class="govuk-hint">Number of hours worked:</span>
  ...
  {% if pay_result is defined %}
    <div class="govuk-inset-text govuk-!-margin-top-3">Pay after tax: £{{ "%.2f"|format(pay_result) }}</div>
  {% endif %}
</form>
